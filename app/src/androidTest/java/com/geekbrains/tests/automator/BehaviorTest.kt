...
class BehaviorTest {
    ...
    fun test_SearchIsPositive() {
        ...
        //отправляем запром через автоматор
        val findButton = uiDevice.findObject(UiSelector().text("FIND"))
        findButton.click()
        ...
        Assert.assertEquals(changedText.text.toString(), "Number of results: 718")
    }
